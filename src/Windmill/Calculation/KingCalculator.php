...
class KingCalculator extends AbstractPieceCalculator
{
    ...
    {
        if (
            ($game->currentColor() == Color::WHITE && !$game->castlingAvailability->whiteCanCastleQueenside && !$game->castlingAvailability->whiteCanCastleKingside)
            || ($game->currentColor() == Color::BLACK && !$game->castlingAvailability->blackCanCastleQueenside && !$game->castlingAvailability->blackCanCastleKingside)
        ) {
            return;
        }
